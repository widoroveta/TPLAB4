                ...
                <table class="blue center-align" style="margin:20px;max-width:80%;">
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td><a href="<?= FRONT_ROOT . "image/showImage?varController=CompanyPanel&varRoute=$img" ?>" class="btn-floating green"><i class="material-icons">image</i></a>
                            </td>
                            <td><a href="<?= FRONT_ROOT . "CompanyPanel/showModifyJobOffer?varId=$id" ?>" class="btn-floating deep-purple accent-4"><i class="material-icons">mode_edit</i></a></td>
                            <td><a href="<?= FRONT_ROOT . "PDF/dowloadPDF?varId=$id&varController=CompanyPanel" ?>" class="btn-floating red"><i class="material-icons">picture_as_pdf</i></a></td>
