        ...
        <div class="row">
            ...
            <form action="<?= FRONT_ROOT . 'admin/addNewUser' ?>" method="post">
                ...
                <div class="form-group">
                    ...
                    <input type="password" value="" placeholder="123456" onchange="verificarPasswords2(); return false" class="form-control" id="pass3" required>
                </div>
                <div class="form-group">
                    <label for="pass2">Vuelve a escribir la Contraseña</label>
                    <input type="password" name="pass" placeholder="123456" value="" onchange="verificarPasswords2(); return false" class="form-control" id="pass4" required>
                </div>
