        ...
        <div class="row">
            <div class="card-panel z-depth-4 col s5  push-s1 white " style="padding: 25px">
                <form action="<?= FRONT_ROOT . "admin/addCompany" ?>" class="">
                    ...
                    <button class="right-align white " style="border:none;" type="submit"><a class="btn-floating btn-large waves-effect waves-light indigo darken-4 "><i class="material-icons">add</i></a> </button>
                </form>
            </div>
        </div>
    </section>
