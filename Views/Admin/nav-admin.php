...
<div class="nav-wrapper center-align z-depth-5 ">
      ...
      <div class="col s12 ">
        ...
        <a href="<?=FRONT_ROOT."Admin/showListAppoinment"?>"  class="breadcrumb z-depth-5  pink-text  cyan-text">Ver todas las postulaciones </a>
        <a href="<?=FRONT_ROOT."Admin/showListJobOffer"?>"  class="breadcrumb z-depth-5  pink-text  cyan-text">Ver puestos de trabajo </a>

      </div>
    </div>

<!--<img src="--><?//=IMG_PATH."bar.gif"?><!--" alt="" style="position:fixed; max-height: 100px; margin-top: -45px; margin-bottom: 0px;" width="100%">-->
