...
<section style="min-height: 100%">
    ...
    if (!empty($jobOfferList)) {
                    ...
                    <div class="card ">
                        ...
                        <div class="card-content  z-depth-4 black purple-text text-accent-2" style="min-height: 200px">
                            ...
                            <ul>
                                ...
                                <li><b>Carrera:</b> <?= $jobOffer->getJobPosition()->getCareer()->getDescription() ?>
                                </li>
                        ...
                        <div class="black"><a href="<?= FRONT_ROOT . "admin/showModifyJobOffer?varId=$id" ?>"
                            ...
                            <a href="<?= FRONT_ROOT . "PDF/dowloadPDF?varId=$id&varController=admin" ?>"
                               class="btn-floating  waves-effect waves-light red"><i class="material-icons">picture_as_pdf</i></a>
                            <a href="<?= FRONT_ROOT . "image/showImage?varController=admin&varRoute=$img" ?>"
                               class="btn-floating  waves-effect waves-light green"><i class="material-icons">image</i></a>
                        </div>
                    </div>
                </div>
        ...
        ?>
        <div class="row ">
            <div class="card-Panel  cyan darken-4 green-text  text-accent-2 col s6 push-s3"
