                ...
                ?>
                    ...
                    <div class="col s2 ">
                        <div class="card ">
                            ...
                            <div class="black"><a href="<?= FRONT_ROOT . "admin/showModifyJobOffer?varId=$id" ?>" class="btn-floating waves-effect waves-light deep-purple accent-4"><i class="material-icons">mode_edit</i></a>
