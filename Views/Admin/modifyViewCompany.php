...
<body class="grey darken-3">
    <section style="min-height: 100%">
        ...
        <div id="modal-name" class="modal bottom-sheet">
        ...
        <div id="modal-city" class="modal bottom-sheet">
            <div class="modal-content">
        ...
        <div id="modal-address" class="modal bottom-sheet">
            <div class="modal-content">
        ...
        <div id="modal-size" class="modal bottom-sheet">
            <div class="modal-content">
        ...
        <div id="modal-email" class="modal bottom-sheet">
            <div class="modal-content">
        ...
        <div id="modal-phoneNumber" class="modal bottom-sheet">
            <div class="modal-content">
        ...
        <div id="modal-cuit" class="modal bottom-sheet">
            <div class="modal-content">
